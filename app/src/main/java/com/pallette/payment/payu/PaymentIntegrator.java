...
public class PaymentIntegrator {
	 ...
	 */
    public Map<String, String> hashCalMethod(Order order)  throws ServletException, IOException, JSONException {
			...
			for (CommerceItem item : commerceItemList) {
				...
				if (StringUtils.isEmpty(productId)) {
					...
					if (prodItem.isPresent()) {
						...
						itemJson.put(PaymentConstants.NAME, prodItem.get().getProductTitle());
						itemJson.put(PaymentConstants.DESCRIPTION, prodItem.get().getProductDescription());
