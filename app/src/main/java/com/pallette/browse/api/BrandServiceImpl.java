...
public class BrandServiceImpl implements BrandService{
	...
	public BrandResponseBean getBrandById(long brandId) throws IllegalAccessException, InvocationTargetException {
		...
		Optional<BrandDocument> brand = brandRepository.findById(brandId);
		if (null != brand) {
			logger.info(String.format("BrandServiceImpl.getBrandById - retrieved Brand is: " , brand.get().getId()));
			response = browseServices.constructBrandResponse(new ArrayList<BrandDocument>(Arrays.asList(brand.get())));
		} else {
