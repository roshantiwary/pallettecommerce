...
public class JavaIntegrationKit {
    ...
    public Map<String, String> hashCalMethod(HttpServletRequest request, HttpServletResponse response)
        ...
        Map<String, String> urlParams = new HashMap<String, String>();
         ...
         params.put("amount", String.valueOf(request.getAttribute("amount")));
         params.put("firstname",(String) request.getAttribute("firstname"));
         params.put("email",(String) request.getAttribute("email"));
         params.put("phone",(String) request.getAttribute("phone"));
         params.put("productinfo",(String) request.getAttribute("productinfo"));
         params.put("surl",(String) request.getAttribute("surl"));
         params.put("furl",(String) request.getAttribute("furl"));
         params.put("service_provider",(String) request.getAttribute("service_provider"));
        ...
        urlParams.put("service_provider", (String) request.getAttribute("service_provider"));
